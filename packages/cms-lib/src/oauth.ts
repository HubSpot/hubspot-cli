import OAuth2Manager = require('@hubspot/api-auth-lib/OAuth2Manager');
import { updatePortalConfig, writeConfig, getPortalConfig } from './lib/config';
import { logger, logErrorInstance } from './logger';
...
export const getOauthManager = (portalId, portalConfig) => {
...
export const authenticateWithOauth = async configData => {
