...
import { getEnv, getPortalConfig } from '../lib/config';
 ...
 * @returns {Promise}
 */
export async function upload(portalId, src, dest, options = {}) {
 ...
 */
export async function fetchModule(portalId, moduleId, options = {}) {
 ...
 * @returns {Promise<FileMapperNode>}
 */
export async function download(portalId, filepath, options = {}) {
  return http.get(portalId, {
 ...
 * @returns {Promise<FileMapperNode>}
 */
export async function downloadDefault(portalId, filepath, options = {}) {
  return http.get(portalId, {
 ...
 * @returns {Promise}
 */
export async function deleteFile(portalId, filePath, options = {}) {
 ...
 * @returns {Promise}
 */
export async function deleteFolder(portalId, folderPath, options = {}) {
  logger.warn(
 ...
 * @returns {Promise}
 */
export async function trackUsage(eventName, eventClass, meta = {}, portalId) {
  const usageEvent = {
    portalId,
    eventName,
    eventClass,
