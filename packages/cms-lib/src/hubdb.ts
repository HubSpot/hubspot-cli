...
export async function addRowsToHubDbTable(portalId, tableId, rows, columns) {
...
export async function createHubDbTable(portalId, src) {
...
export async function updateHubDbTable(portalId, tableId, src) {
  validateJsonFile(src);
...
export async function downloadHubDbTable(portalId, tableId, dest) {
...
export async function clearHubDbTableRows(portalId, tableId) {
  let totalRows = null;
  let rows = [];
  let count = 0;
  let offset = 0;
