    ...
    describe('StatusCodeError', () => {
      ...
      it('should log a readable error message from provided Status Code error and optional context data', () => {
        expect(logger.logs[LOG_LEVEL.ERROR]).toEqual([
          'The request for "a/b/c" on portal 12345 failed.',
          'The request on portal 12345 was not found.',
          ...
          'The delete of "a/b/c" on portal 12345 failed due to a server error.',
          'The request for "a/b/c" on portal 12345 failed due to a server error.',
          'Unable to upload "new.js". The post to "a/b/c" on portal 12345 failed due to a server error.',
          'The request for "a/b/c" on portal 12345 could not be handled at this time. Please try again later.',
