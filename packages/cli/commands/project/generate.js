...
} = require('../../lib/prompts/generateProjectPrompt');
const {
  copyAndParseDir,
  readGeneratorFile,
  downloadGithubRepo,
  cleanUpTempDir,
} = require('../../lib/boilerplateGenerator');
const {
  generateQuestionPrompt,
} = require('../../lib/prompts/generateQuestionPrompt');
...
const choices = [
  {
    name: 'Basic App',
    value:
      'https://github.com/camden11/hs-generate-templates/tree/main/basic-app',
  },
  {
    name: 'App With Form',
    value:
      'https://github.com/camden11/hs-generate-templates/tree/main/app-with-form',
  },
];
...
exports.handler = async options => {
  ...
  copyAndParseDir(
    tempComponentLocation,
    '../test-component-boilerplate',
    generatorObject.componentRoot,
    answers
  );
