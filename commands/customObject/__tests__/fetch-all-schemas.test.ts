...
import schemaFetchAllCommand from '../fetchAllSchemas.js';

vi.mock('yargs');
vi.mock('../../../lib/commonOpts');

describe('commands/customObject/fetchAllSchemas', () => {
  ...
  describe('command', () => {
    it('should have the correct command structure', () => {
      expect(schemaFetchAllCommand.command).toEqual('fetch-all-schemas [dest]');
    });
  });
