...
import schemaUpdateCommand from '../updateSchema.js';

vi.mock('yargs');
vi.mock('../../../lib/commonOpts');

describe('commands/customObject/updateSchema', () => {
  ...
  describe('command', () => {
    it('should have the correct command structure', () => {
      expect(schemaUpdateCommand.command).toEqual('update-schema [name]');
    });
  });
