...
import schemaFetchCommand from '../fetchSchema.js';

vi.mock('yargs');
vi.mock('../../../lib/commonOpts');

describe('commands/customObject/fetchSchema', () => {
  ...
  describe('command', () => {
    it('should have the correct command structure', () => {
      expect(schemaFetchCommand.command).toEqual('fetch-schema [name] [dest]');
    });
  });
