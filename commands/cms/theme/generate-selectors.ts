...
const describe =
  commands.cms.subcommands.theme.subcommands.generateSelectors.describe;

export type ThemeSelectorArgs = CommonArgs & { path: string };
...
async function handler(
  ...
  uiLogger.success(
    commands.cms.subcommands.theme.subcommands.generateSelectors.success(
      path,
      selectorsPath
    )
  );
