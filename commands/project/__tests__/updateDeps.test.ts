...
import projectUpdateDepsCommand, {
...
describe('commands/project/updateDeps', () => {
  describe('command', () => {
    it('should have the correct command structure', () => {
      expect(projectUpdateDepsCommand.command).toEqual(
  ...
  describe('describe', () => {
    it('should not provide a description', () => {
      expect(projectUpdateDepsCommand.describe).toEqual(
  ...
  describe('builder', () => {
    it('should provide examples', () => {
      projectUpdateDepsCommand.builder(yargs as Argv);
      expect(exampleSpy).toHaveBeenCalledTimes(1);
    });
  });

  describe('handler', () => {
    let args: ArgumentsCamelCase<ProjectUpdateDepsArgs>;

    beforeEach(() => {
      args = {
        derivedAccountId: 999999,
      } as ArgumentsCamelCase<ProjectUpdateDepsArgs>;
